...
namespace IIS.Горводоканал
{
    ...
    [View("СотрудникL", new string[] {
            ...
            "Email as \'Email\'",
            "Актуально as \'Актуально\'"})]
    public class Сотрудник : IIS.Горводоканал.Справочник
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.Горводоканал.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.Горводоканал.Сотрудник));
                }
            }
        }
    }
